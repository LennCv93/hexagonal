...
CREATE INDEX idx_transactions_account_origin_id      ON transactions(account_origin_id);
CREATE INDEX idx_transactions_account_destination_id ON transactions(account_destination_id);
